...
export default function Formatter({ id, name, description }: FormatterProps) {
  ...
  const getPresets = () => {
    if (id.includes('json')) return [{ label: 'Object', value: '{"name":"DevToolKit","version":"2.4.0","features":["Formatter","Generator","Converter"],"active":true,"metadata":{"tags":["tool","dev","productivity"]}}' }, { label: 'Array', value: '[{"id":1,"task":"Fix bugs"},{"id":2,"task":"Deploy"},{"id":3,"task":"Write Readme"}]' }];
    ...
    if (id.includes('xml')) return [{ label: 'RSS', value: '<?xml version="1.0" encoding="UTF-8" ?><rss version="2.0"><channel><title>Latest News</title><link>http://example.com</link><description>Global Headlines</description><item><title>DevToolKit 2.4.0 Released</title><link>http://example.com/2.4.0</link></item></channel></rss>' }];
